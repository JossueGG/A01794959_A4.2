...
def convert_to_hexadecimal(num):
    ...
    Parámetros:
        num (int): Número entero a convertir.
    Retorna:
        str: Cadena que representa el número en hexadecimal. Para negativos se muestran 8 dígitos.
    """
...
def main():
    ...
    Se encarga de leer los datos, convertir los números a binario (10 bits en complemento a dos
    para negativos) y a hexadecimal (32 bits en complemento a dos para negativos), y mostrar y
    ...
    for idx, num in enumerate(numeros, start=1):
        ...
        line = (
            f"Número {idx}: {num} | Binario : {binario} | "
